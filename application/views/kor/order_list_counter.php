	...
	<div id="modal_order_insert" class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	  ...
	  <div class="modal-dialog">
		<div class="modal-content">
		  ...
		  <div class="modal-body">
			<iframe id="order_wait_frame" style='border:1px solid black;width:100%;height:100%'></iframe>
		  </div>
		  <div class="modal-footer">
	  ...
	  <div class="modal-dialog">
		<div class="modal-content">
		  ...
		  <div class="modal-body">
			<iframe id="order_complete_frame"  style='border:1px solid black; width:100%;height:100%'></iframe>
		  </div>
		  <div class="modal-footer">
