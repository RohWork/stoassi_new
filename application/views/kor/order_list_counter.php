	...
	<div id="modal_order_insert" class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                            ...
                            <div class="form-group">
                                <div class="col-sm-12" style="text-align: center" id='qr_print_area'>
                                    <div style='border: 1px solid black'>
                                        <img id='qr_code_img' style='width:250px; height:250px;webkit-print-color-adjust:exact;'/>
                                    </div>
                                </div>
                            </div>
			</form>
	  ...
	  <div class="modal-dialog">
		<div class="modal-content">
		  ...
		  <div class="modal-body">
			<iframe id="order_wait_frame" style='border:1px solid black;width:100%;'></iframe>
		  </div>
		  <div class="modal-footer">
	  ...
	  <div class="modal-dialog">
		<div class="modal-content">
		  ...
		  <div class="modal-body">
			<iframe id="order_complete_frame"  style='border:1px solid black; width:100%;'></iframe>
		  </div>
		  <div class="modal-footer">
