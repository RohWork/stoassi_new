        ...
        function menu_check_go(idx, element){
            if($("#menu_array").val().indexOf(idx) != -1){
                ...
                $("#menu_list").append(
                        ...
                        "<td>"+
                        "<input type='text' maxlength='3' size='3' id='cnt_"+idx+"' name='cnt_"+idx+"' class='form-control' readonly value='1' style='text-align:center;width:30px'/>&nbsp;"+
