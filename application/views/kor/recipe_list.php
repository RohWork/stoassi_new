...
<script>
    ...
    function recipe_val_add(){
        ...
        recipe_html += "<div class='row'>"
                        ...
                        +"<div class='col-md-1'> <span class='form-control '>투입재료:</span><div>"
                        +"<div class='col-md-1'><select class='form-control  col-md-1' id='stock_idx[]' name='stock_idx[]'>"
                        +  "<option value='1'>진간장</option>"
                        +"</select></div>"
                        +"<div class='col-md-1'><input class='form-control  col-md-1' type='text' id='stock_cnt[]' name='stock_cnt[]'/><div>"
                        +"<div class='col-md-1'><span class='form-control  col-md-1' id='stock_unit[]' name='stock_unit[]'></span</div>"
                        +"<div class='col-md-1'><span class='form-control  col-md-1'>소요시간:</span></div>"
