<footer>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-2 col-xs-3" style="text-align: center" onclick="$('#myModal').modal('show');check_basket();"><span id="view_basket_cnt" class="glyphicon glyphicon-inbox"></span></div>
